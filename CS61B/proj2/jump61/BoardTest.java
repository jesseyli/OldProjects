...
public class BoardTest {
    ...
    public void testMove() {
        ...
        assertEquals("Wrong player's move", RED, B.whoseMove());
        B.addSpot(RED, 1, 1);
        checkBoard("#1", B, 1, 1, 1, RED);
        assertEquals("This move should not be legal", false,
                B.isLegal(BLUE, 0));
        B.addSpot(BLUE, 2, 1);
        ...
        assertEquals("Wrong number of moves", 6, B.numMoves());
        B.undo();
        ...
        B.setMoves(2);
        assertEquals("Wrong player's move", BLUE, B.whoseMove());
    }
