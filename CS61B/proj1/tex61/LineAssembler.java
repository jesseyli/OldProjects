...
class LineAssembler {
     ...
     *  LIST combined. */
    int totalChars(ArrayList<String> list) {
        int total = 0;
    ...
    /** Returns the characters of the word currently being accumulated.
     *  Used for unit testing. */
    String getChars() {
        return _chars;
    }

    /** Returns the words of the line currently being accumulated.
     *  Used for unit testing. */
